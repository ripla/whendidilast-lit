...
export type TaskAction =
  | TaskActionAddTask
  | TaskActionRemoveTask
  | TaskActionTaskDone;

type ThunkResult = ThunkAction<void, RootState, undefined, TaskAction>;

export const addTask: ActionCreator<ThunkResult> = (newDescription: string) => (
  dispatch: Dispatch
) => {
...
export const taskDone: ActionCreator<ThunkResult> = (id: string) => (
  dispatch: Dispatch
) => {
...
export const removeTask: ActionCreator<ThunkResult> = (id: string) => (
  dispatch: Dispatch
) => {
